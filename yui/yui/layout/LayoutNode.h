...
public:
    ...
    [[nodiscard]] Rect absolute_rect() const {
        return {
                .top = m_position.y,
                .left = m_position.x,
    ...
    [[nodiscard]] glm::ivec2 position() const { return m_position; }

    [[nodiscard]] glm::ivec2 inner_position() const;
    [[nodiscard]] glm::ivec2 inner_size() const;

    // The size of this element (excluding padding).
    [[nodiscard]] glm::ivec2 size() const { return m_size; }

    [[nodiscard]] glm::ivec2 size_with_padding() const;

    void set_dom_node(Node *dom_node);
    [[nodiscard]] Node *dom_node() const { return m_dom_node; }

    // TODO: Sync next/previous etc at every insert/erase/replace.
    [[nodiscard]] LayoutNode *next() const { return m_next; }
    [[nodiscard]] LayoutNode *previous() const { return m_previous; }
    [[nodiscard]] LayoutNode *parent() const { return m_parent; }
    [[nodiscard]] const std::vector<LayoutNode *> &children() const { return m_children; }
    ...
    [[nodiscard]] DocumentWidget *document_widget() const { return m_document_widget; }
    void set_document_widget(DocumentWidget *);

    [[nodiscard]] virtual bool is_inline() const { return false; }
    [[nodiscard]] virtual bool is_inline_box() const { return false; };
    [[nodiscard]] virtual bool is_input() const { return false; }
    [[nodiscard]] virtual bool is_box() const { return false; }
    [[nodiscard]] virtual bool hit_test(int x, int y) const;
    [[nodiscard]] virtual bool is_root() const { return false; }
    ...
    [[nodiscard]] virtual const char *layout_name() const { return "LayoutNode"; }
