...
public:
    ...
    [[nodiscard]] bool is_inline() const override { return false; }
    ...
    [[nodiscard]] glm::ivec2 character_size() const { return m_character_size; }

    [[nodiscard]] const char *layout_name() const override { return "textarea"; }
