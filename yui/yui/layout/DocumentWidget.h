...
namespace yui::layout {
	...
	public:
		...
		DocumentNode* dom_document() const { return m_dom_document; }
		void set_dom_document(DocumentNode *node);

		void paint(yui::Painter&) override;
		void update(float dt) override;
		void compute() override;
		bool has_loaded_font(const std::string& font_name, int font_size) const;
		...
		const char* layout_name() const override { return "document"; }
