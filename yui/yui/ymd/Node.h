...
namespace yui {
	...
	public:
		...
		const ImmutableComputedValues& computed() const { return m_computed; }
		...
		const ClassList& class_list() const { return m_class_list; }
		bool children_are_fragments() const;
