...
public:
    ...
    [[nodiscard]] const std::string &source_file() const { return m_source_file; };
private:
...
public:
    ...
    [[nodiscard]] const Node *current_ui_state_node(NodeUiState) const;
    ...
    [[nodiscard]] const std::vector<Stylesheet> &stylesheets() const { return m_stylesheets; };
