...
{
	return find_if([&c](const auto& decoded) {
...
{
	return find_if([&code_point](const auto& decoded) {
...
{
	return find_if([&decoded_code_point](const auto& decoded) {
...
{
	return find_if(offset, [&c](const auto& decoded) {
		return decoded.length_in_bytes == 1 && static_cast<char>(decoded.code_point) == c;
	});
}
...
{
	return find_if(offset, [&code_point](const auto& decoded) {
		return decoded.code_point == code_point;
	});
}
...
{
	return find_if(offset, [&decoded_code_point](const auto& decoded) {
		return decoded_code_point.code_point == decoded.code_point;
	});
}
