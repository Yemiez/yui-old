...
struct Color {
    ...
    [[nodiscard]] Color lerp(Color, float t) const;
    [[nodiscard]] float fr() const { return static_cast<float>(r) / 255.f; }
    [[nodiscard]] float fg() const { return static_cast<float>(g) / 255.f; }
    [[nodiscard]] float fb() const { return static_cast<float>(b) / 255.f; }
    [[nodiscard]] float fa() const { return static_cast<float>(a) / 255.f; }

    [[nodiscard]] Color with_r(uint32_t) const;
    [[nodiscard]] Color with_g(uint32_t) const;
    [[nodiscard]] Color with_b(uint32_t) const;
    [[nodiscard]] Color with_a(uint32_t) const;
    [[nodiscard]] Color with_r(float) const;
    [[nodiscard]] Color with_g(float) const;
    [[nodiscard]] Color with_b(float) const;
    [[nodiscard]] Color with_a(float) const;
...
struct DrawList {
    ...
    DrawCmd &push(
            ...
            Primitive prim = Primitive::Triangles
    );
...
class Painter {
public:
    explicit Painter(Window *);
    Painter(const Painter &) = delete;
    Painter(Painter &&) = delete;
    virtual ~Painter() = default;

    // Misc
    [[nodiscard]] bool debug() const { return m_debug; }
    ...
    [[nodiscard]] glm::ivec2 viewport() const { return m_viewport; }
