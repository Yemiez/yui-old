...
{
#define _STYLESHEET_PROPERTIES_ENUMERATOR_(a, b, c, ...) \
...
{
#define _STYLESHEET_PROPERTIES_ENUMERATOR_(a, b, c, className) if (id == StylesheetPropertyId::a) return new className(std::move(value));
	STYLESHEET_PROPERTIES_ENUMERATOR
#undef _STYLESHEET_PROPERTIES_ENUMERATOR_
