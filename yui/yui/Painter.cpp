...
yui::DrawCmd &yui::DrawList::push(
        Vertex *vertices, size_t vertices_count, DrawIndex *indices, size_t indices_count,
        Primitive prim
) {
    ...
    std::transform(
            indices, indices + indices_count, indices, [&vbo_offset](auto &it) {
...
void yui::Painter::render() {
    ...
    glVertexAttribPointer(
            1, 1, GL_FLOAT, false, sizeof(Vertex),
    ...
    glVertexAttribPointer(
            3, 4, GL_FLOAT, false, sizeof(Vertex),
...
void yui::Painter::text(
        const Utf8String &view,
        const Color &color,
        int x,
        int y,
        FontResource &font,
...
void yui::Painter::text(
    ...
    for (const auto info : view) {
        ...
        Vertex vertices[] = {
                {
                        .position = { xpos, ypos + h }, .use_sampler=1, .uv={ 0.0f, 1.0f }, .color= {
                        color.fr(),
                        color.fg(),
                        color.fb(),
                        color.fa()
                ...
                {
                        .position = { xpos + w, ypos }, .use_sampler=1, .uv={ 1.0f, 0.0f }, .color= {
                        color.fr(),
                        color.fg(),
                        color.fb(),
                        color.fa()
                ...
                {
                        .position = { xpos, ypos }, .use_sampler=1, .uv={ 0.0f, 0.0f }, .color= {
                        color.fr(),
                        color.fg(),
                        color.fb(),
                        color.fa()
                ...
                {
                        .position = { xpos + w, ypos + h }, .use_sampler=1, .uv={ 1.0f, 1.0f }, .color= {
                        color.fr(),
                        color.fg(),
                        color.fb(),
                        color.fa()
...
void yui::Painter::fill_rect(float x, float y, float w, float h, const Color &color, glm::fvec4 clip_rect) {
    Vertex vertices[] = {
            ...
            {
                    .position = { x + w, y + h }, .use_sampler=0, .color= {
                    color.fr(),
                    color.fg(),
                    color.fb(),
                    color.fa()
...
void yui::Painter::outline_rect(
    ...
    if (thickness > 1.0f) {
        ...
        Vertex vertices[] = {
                // Top
                {
                        .position = { x1, y1 + thickness }, .use_sampler=0, .color= {
                        color.fr(),
                        color.fg(),
                        color.fb(),
                        color.fa()
                ...
                {
                        .position = { x2, y1 + thickness }, .use_sampler=0, .color= {
                        color.fr(),
                        color.fg(),
                        color.fb(),
                        color.fa()
                ...
                // left
                {
                        .position = { x1, y2 + thickness }, .use_sampler=0, .color= {
                        color.fr(),
                        color.fg(),
                        color.fb(),
                        color.fa()
                ...
                {
                        .position = { x1 + thickness, y2 + thickness }, .use_sampler=0, .color= {
                        color.fr(),
                        color.fg(),
                        color.fb(),
                        color.fa()
                ...
                {
                        .position = { x1 + thickness, y1 + thickness }, .use_sampler=0, .color= {
                        color.fr(),
                        color.fg(),
                        color.fb(),
                        color.fa()
                ...
                // Bottom
                {
                        .position = { x2 + thickness, y2 + thickness }, .use_sampler=0, .color= {
                        color.fr(),
                        color.fg(),
                        color.fb(),
                        color.fa()
                ...
                {
                        .position = { x2 + thickness, y2 }, .use_sampler=0, .color= {
                        color.fr(),
                        color.fg(),
                        color.fb(),
                        color.fa()
                ...
                {
                        .position = { x1 + thickness, y2 }, .use_sampler=0, .color= {
                        color.fr(),
                        color.fg(),
                        color.fb(),
                        color.fa()
                ...
                // Right
                {
                        .position = { x2, y2 + thickness }, .use_sampler=0, .color= {
                        color.fr(),
                        color.fg(),
                        color.fb(),
                        color.fa()
                ...
                { .position = { x2, y1 }, .use_sampler=0, .color= { color.fr(), color.fg(), color.fb(), color.fa() } },
                {
                        .position = { x2 + thickness, y1 }, .use_sampler=0, .color= {
                        color.fr(),
                        color.fg(),
                        color.fb(),
                        color.fa()
        ...
        Vertex vertices[] = {
                ...
                { .position = { x, y }, .use_sampler=0, .color= { color.fr(), color.fg(), color.fb(), color.fa() } },
                {
                        .position = { x + w, y }, .use_sampler=0, .color= {
                        color.fr(),
                        color.fg(),
                        color.fb(),
                        color.fa()
                ...
                {
                        .position = { x, y + h }, .use_sampler=0, .color= {
                        color.fr(),
                        color.fg(),
                        color.fb(),
                        color.fa()
